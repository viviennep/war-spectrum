...
with open('./hyperparam_opt/stuff/stuff_params.json','r') as f:
...
stuff_model.fit(df, train_inds=train_inds, valid_inds=valid_inds)
stuff_model.save(model_dir/'pitch_quality/stuff.joblib')
